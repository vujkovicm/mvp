###==================================
### Written by Wei Zhao (zhaowei1@mail.med.upenn.edu)
...
### data handling
###=============================
in.data <- read.table(file = args[1], header = TRUE, sep = " ", stringsAsFactors = FALSE)
#dim(in.data)
#names(in.data)
...
else if (floor(y.tick.max / y.tick.interval2) <= 13) 
{
...
png(filename = out.manh.path, width = 1000, height = 700)
